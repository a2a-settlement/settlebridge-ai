...
export interface User {
  ...
  managed_developer_id: string | null;
  bio: string | null;
  created_at: string;
}
...
/** Exchange / marketplace agent directory row (API GET /agents, GET /agents/:id). */
export interface ExchangeAgentSummary {
  id: string;
  bot_name: string;
  developer_id?: string;
